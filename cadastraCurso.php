...
?>
	<p class="alert-success">O curso <?php echo $curso->tipoCurso; ?> foi adicionado com sucesso! </p>
<?php } else {
	$msg = mysqli_error($conexao);
?>
	<p class="alert-danger">O produto <?php echo $curso->tipoCurso; ?> não foi adicionado: <?php echo $msg ?></p>
<?php 
}