...
?>
	<p class="alert-success" id="mostra-alerta">A disciplina <?php echo $disciplina->nome; ?> foi adicionada com sucesso!</p>
<?php } else {
	$msg = mysqli_error($conexao);
?>
	<p class="alert-danger" id="mostra-alerta">A disciplina <?php echo $disciplina->nome; ?> não foi adicionada: <?php echo $msg ?></p>
<?php 
}